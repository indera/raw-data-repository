...
PROJECT_MAP = {'pmi-drc-api-test': {'api_key': 'AIzaSyCAuQdK6L5AU7c1EOhkeJwEw-7oCs5HsiE',
                                    ...
                                    'notification_channel_ids': ['841940086686265891',
                                                                 '7271756574530877070']},
            ...
            'all-of-us-rdr-prod': {'api_key': 'AIzaSyAUcQj4l-8DfqS5-A_InN7VD8ZN_lLtflU',
                                   ...
                                   'notification_channel_ids': ['771610197803600435',
                                                                '13127179291565379182']}}
...
def write_policies(policy_file, policies, metric_descriptors):
  ...
  logging.info('Wrote %d policies and %d metric descriptors to %s.' % (len(policies),
                                                                       len(metric_descriptors),
                                                                       policy_file))
